...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gaohongcheng/UserCenterModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gaohongcheng' => 'gaohongcheng@58ganji.com' }
  s.source           = { :git => 'https://github.com/gaohongcheng/UserCenterModule.git', :tag => s.version.to_s }
